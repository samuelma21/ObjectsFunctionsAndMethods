...
#                attach_to(self, window_or_canvas), clone(self), move_by(self, dx, dy)
#
...
#            When the window should close on the user's click
#
