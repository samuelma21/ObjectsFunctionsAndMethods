...
def try_methods():
    ...
    turtleA.pen = rg.Pen('brown',5)
    turtleA.forward(150)
    turtleA.left(90)
    turtleA.forward(50)
    turtleA.backward(100)
...
def try_methods_and_functions():
    ...
    #
    ####################################################################
    turtleZ = rg.SimpleTurtle()
    turtleZ.pen = rg.Pen('blue', 5)
    turtleZ.backward(150)
    turtleZ.speed = 1
    draw_many_squares(turtleZ,2,100,30)
    turtleZ.speed = 5
    turtleZ.pen.color = 'red'
    draw_many_squares(turtleZ, 10, 50, 15)
    turtleZ.speed = 100
    turtleZ.pen.thickness = 35
    draw_many_squares(turtleZ, 8, 300, 60)
    turtleZ.pen = rg.Pen('black', 3)
    turtleZ.backward(200)
    turtleZ.draw_circle(30)
    turtleZ.draw_square(50)
